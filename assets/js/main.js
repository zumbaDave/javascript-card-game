...
const cardObjectDefinitions = [
    {id:1, imagePath:'/assets/images/pinery/pinery1.png'},
    {id:2, imagePath:'/assets/images/pinery/pinery2.png'},
    {id:3, imagePath:'/assets/images/pinery/pinery3.png'},
    {id:4, imagePath:'/assets/images/pinery/nina.png'}
]

const aceId = 4

const cardBackImgPath = '/assets/images/card-back-water.png'
...
function gameOver()
{
    ...
    const gameOverMessage = `Game Over! Final Score - <span class = 'badge'>${score}</span> Click 'Play Game' button to find Nina again`
...
function outputChoiceFeedBack(hit)
{
    if(hit)
    {
        updateStatusElement(currentGameStatusElem, "block", winColor, "You found Nina!!! :)")
    }
    else
    {
        updateStatusElement(currentGameStatusElem, "block", loseColor, "Nope... Nina is not there!!! :(")
    }
}
...
function shuffleCards()
{
    ...
    function shuffle()
    {
        ...
        if(shuffleCount == 500)
        {
            ...
            dealCards()
            updateStatusElement(currentGameStatusElem, "block", primaryColor, "Please click the card where you think Nina is hiding...")
